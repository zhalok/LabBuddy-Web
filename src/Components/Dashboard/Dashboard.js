    ...
    <div>
      <div className="d-flex container-full">
        <div className="w-15 bg-theme-light p-3">
            ...
            <div className="d-flex"><DashboardCustomizeIcon className='me-2'/> Dashboard </div> </button>
            <button className="text-light btn btn-theme-dark px-5 py-2 rounded my-2 w-100 " onClick={()=>{
              setUi("class") }}> 
              <div className="d-flex "><PeopleAltIcon className='me-2'/> Class </div> </button>
            <button className="text-light btn btn-theme-dark px-5 py-2 rounded my-2 w-100" onClick={()=>{
              setUi("lab")}}> <div className="d-flex "><BiotechIcon className='me-2'/> Lab </div> </button>
            <button className="text-light btn btn-theme-dark px-5 py-2 rounded my-2 w-100" onClick={()=>{
